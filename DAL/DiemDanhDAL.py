...
class DiemDanhDAL:
    ...
    def update( dd: DiemDanh):
       # Câu lệnh update dữ liệu
        ...
        data = (dd._masv, dd._giovao, dd._giora, 
    ...
    def find(key, value):
        ...
        query = "SELECT dd.madiemdanh, dd.masv, sv.hoten, l.tenlop, "\
            + "dd.giovao, dd.giora, dd.ngay, dd.mabuoihoc, dd.trangthai, "\
            + "dd.hinhanh FROM diemdanh dd, sinhvien sv, lop l WHERE "\
            + "l.malop = sv.malop AND dd.masv = sv.masinhvien AND {} LIKE '%{}%'".format(key, value)
    ...
    def add( dd: DiemDanh):
        query = "INSERT INTO diemdanh (madiemdanh, masv, giovao, giora, ngay, mabuoihoc, trangthai)"\
                "VALUES(%s, %s, %s, %s, %s, %s, %s)"
        data = (dd._madiemdanh, dd._masv, dd._giovao, dd._giora, 
