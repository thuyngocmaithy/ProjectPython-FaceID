# Form implementation generated from reading ui file 'c:\Users\Duyen\OneDrive\Documents\github\ProjectPython-FaceID\.venv\Lib\site-packages\qdarkstyle\example\ui\dw_views.ui'
#
...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.label_70 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_80 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_27 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.listViewDis = QtWidgets.QListView(parent=self.dockWidgetContents)
        ...
        self.label_59 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.treeViewDis = QtWidgets.QTreeView(parent=self.dockWidgetContents)
        ...
        self.label_60 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tableViewDis = QtWidgets.QTableView(parent=self.dockWidgetContents)
        ...
        self.label_61 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.columnView = QtWidgets.QColumnView(parent=self.dockWidgetContents)
        self.columnView.setObjectName("columnView")
        self.gridLayout.addWidget(self.columnView, 4, 1, 1, 1)
        self.columnViewDis = QtWidgets.QColumnView(parent=self.dockWidgetContents)
