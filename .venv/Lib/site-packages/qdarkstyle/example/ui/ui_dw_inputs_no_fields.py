# Form implementation generated from reading ui file 'c:\Users\Duyen\OneDrive\Documents\github\ProjectPython-FaceID\.venv\Lib\site-packages\qdarkstyle\example\ui\dw_inputs_no_fields.ui'
#
...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.dial = QtWidgets.QDial(parent=self.dockWidgetContents)
        ...
        self.label_25 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        ...
        self.horizontalScrollBarDis = QtWidgets.QScrollBar(parent=self.dockWidgetContents)
        ...
        self.horizontalScrollBarDis.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.verticalSlider = QtWidgets.QSlider(parent=self.dockWidgetContents)
        ...
        self.label_24 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        ...
        self.horizontalSlider = QtWidgets.QSlider(parent=self.dockWidgetContents)
        ...
        self.horizontalSliderDis = QtWidgets.QSlider(parent=self.dockWidgetContents)
        ...
        self.horizontalSliderDis.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.horizontalSliderDis.setObjectName("horizontalSliderDis")
        self.gridLayout.addWidget(self.horizontalSliderDis, 4, 2, 1, 1)
        self.label_23 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        ...
        self.verticalScrollBarDis = QtWidgets.QScrollBar(parent=self.dockWidgetContents)
        ...
        self.verticalScrollBarDis.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.verticalScrollBarDis.setObjectName("verticalScrollBarDis")
        self.gridLayout.addWidget(self.verticalScrollBarDis, 5, 2, 2, 1)
        self.label_21 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        ...
        self.verticalScrollBar = QtWidgets.QScrollBar(parent=self.dockWidgetContents)
        ...
        self.horizontalScrollBar = QtWidgets.QScrollBar(parent=self.dockWidgetContents)
        ...
        self.label_22 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        ...
        self.label_50 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        self.label_50.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_50.setObjectName("label_50")
        self.gridLayout.addWidget(self.label_50, 9, 0, 1, 3)
        self.label_11 = QtWidgets.QLabel(parent=self.dockWidgetContents)
        ...
        self.dialDis = QtWidgets.QDial(parent=self.dockWidgetContents)
        ...
        self.verticalSliderDis = QtWidgets.QSlider(parent=self.dockWidgetContents)
        ...
        self.verticalSliderDis.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.verticalSliderDis.setObjectName("verticalSliderDis")
        self.gridLayout.addWidget(self.verticalSliderDis, 7, 2, 1, 1)
        self.comboBoxDis = QtWidgets.QComboBox(parent=self.dockWidgetContents)
