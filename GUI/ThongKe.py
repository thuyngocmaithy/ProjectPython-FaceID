...
class UI_ThongKe(object):
        ...
        def showDiMuon(self):
                ...
                for index, sv in enumerate(list1):
                        count +=1
                        masinhvien = QtWidgets.QTableWidgetItem()
                        masinhvien.setText(sv[0])
                        self.tbwDiMuon.setItem(index, 0, masinhvien)
        ...
        def showVang(self):
                ...
                for index, sv in enumerate(list2):
                        ...
                        masinhvien = QtWidgets.QTableWidgetItem()
                        masinhvien.setText(sv[0])
                        self.tbwVang.setItem(index, 0, masinhvien)
                        ten = QtWidgets.QTableWidgetItem()
                        ten.setText(sv[1])
        ...
        def showKDD(self):
                ...
                for index, sv in enumerate(list3):
                        ...
                        masinhvien = QtWidgets.QTableWidgetItem()
                        masinhvien.setText(sv[0])
                        self.tbwKhongDD.setItem(index, 0, masinhvien)
                        ten = QtWidgets.QTableWidgetItem()
                        ten.setText(sv[1])
