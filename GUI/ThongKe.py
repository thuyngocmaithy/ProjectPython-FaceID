...
"}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("ui\\../image/Student Male_70px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButton.setIcon(icon2)
        self.pushButton.setIconSize(QtCore.QSize(35, 35))
        self.pushButton.setObjectName("pushButton")
        self.lbSoSV = QtWidgets.QLabel(parent=self.frame_2)
        self.lbSoSV.setGeometry(QtCore.QRect(57, 20, 111, 31))
        font = QtGui.QFont()
...
"")
        ...
        self.lblResultSV.setGeometry(QtCore.QRect(65, 50, 61, 31))
        font = QtGui.QFont()
...
"}")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("ui\\../image/document_70px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.lblResultDiemDanh.setGeometry(QtCore.QRect(45, 50, 101, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.lbSoBanDiemDanh.setGeometry(QtCore.QRect(35, 20, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.lbSoLanDiMuon.setGeometry(QtCore.QRect(45, 20, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.lblResultDiMuon.setGeometry(QtCore.QRect(53, 50, 81, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("ui\\../image/hurry_70px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("ui\\../image/high_priority_message_70px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.pushButton_5.setIcon(icon5)
        self.pushButton_5.setIconSize(QtCore.QSize(35, 35))
        self.pushButton_5.setObjectName("pushButton_5")
        self.lblResultVang = QtWidgets.QLabel(parent=self.frame)
        self.lblResultVang.setGeometry(QtCore.QRect(55, 50, 71, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.lbSoLanVang.setGeometry(QtCore.QRect(55, 20, 111, 31))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        self.cmbOptionFindDiMuon.addItem("Trạng thái", "trangthai")
        ...
        self.txtFindDiMuon.returnPressed.connect(self.findDiMuon)
...
"")
        ...
        self.txtFindVang.returnPressed.connect(self.findVang)
        ...
        self.cmbOptionFindVang.addItem("Trạng thái", "trangthai")
...
"")
        ...
        self.txtFindKhongDD.returnPressed.connect(self.findKDD)
        ...
        self.cmbOptionFindKhongDD.addItem("Trạng thái", "trangthai")
...
"}")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("ui\\../image/close_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("ui\\../image/subtract_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def findByMaSvDiMuon(self, sinhviendimuon):
            return self.txtFindDiMuon.text() in sinhviendimuon[0]
    def findByHoTenDiMuon(self, sinhviendimuon):
            return self.txtFindDiMuon.text() in sinhviendimuon[1]
    def findByLopDiMuon(self, sinhviendimuon):
            return self.txtFindDiMuon.text() in sinhviendimuon[2]
    def findByNgayDiMuon(self, sinhviendimuon):
            return self.txtFindDiMuon.text() in sinhviendimuon[3]
    def findByIDBuoiHocDiMuon(self, sinhviendimuon):
            return self.txtFindDiMuon.text() in sinhviendimuon[4]
    def findByTrangThaiDiMuon(self, sinhviendimuon):
            return self.txtFindDiMuon.text() in sinhviendimuon[5]

    def showDiMuon(self):
            list1 = []
            if (self.cmbOptionFindDiMuon.currentText() == 'Mã SV'):
                    list1 = filter(self.findByMaSvDiMuon, self.listDiMuon)
            elif (self.cmbOptionFindDiMuon.currentText() == 'Họ tên'):
                    list1 = filter(self.findByHoTenDiMuon, self.listDiMuon)
            elif (self.cmbOptionFindDiMuon.currentText() == 'Lớp'):
                    list1 = filter(self.findByLopDiMuon, self.listDiMuon)
            elif (self.cmbOptionFindDiMuon.currentText() == 'Ngày'):
                    list1 = filter(self.findByNgayDiMuon, self.listDiMuon)
            elif (self.cmbOptionFindDiMuon.currentText() == 'ID buổi học'):
                    list1 = filter(self.findByIDBuoiHocDiMuon, self.listDiMuon)
            elif (self.cmbOptionFindDiMuon.currentText() == 'Trạng thái'):
                    list1 = filter(self.findByTrangThaiDiMuon, self.listDiMuon)

            count = 0
            for index, sv in enumerate(list1):
                    count +=1
                    masv = QtWidgets.QTableWidgetItem()
                    masv.setText(sv[0])
                    self.tbwDiMuon.setItem(index, 0, masv)
                    ten = QtWidgets.QTableWidgetItem()
                    ten.setText(sv[1])
                    self.tbwDiMuon.setItem(index, 1, ten)
                    lop = QtWidgets.QTableWidgetItem()
                    lop.setText(sv[2])
                    self.tbwDiMuon.setItem(index, 2, lop)
                    ngay = QtWidgets.QTableWidgetItem()
                    ngay.setText(sv[3].strftime('%d/%m/%Y'))
                    self.tbwDiMuon.setItem(index, 3, ngay)
                    mabuoihoc = QtWidgets.QTableWidgetItem()
                    mabuoihoc.setText(sv[4])
                    self.tbwDiMuon.setItem(index, 4, mabuoihoc)
                    trangthai = QtWidgets.QTableWidgetItem()
                    trangthai.setText(sv[5])
                    self.tbwDiMuon.setItem(index, 5, trangthai)
            self.tbwDiMuon.setRowCount(count)

    def findByMaSvVang(self, sinhvienvang):
            return self.txtFindVang.text() in sinhvienvang[0]
    def findByHoTenVang(self, sinhvienvang):
            return self.txtFindVang.text() in sinhvienvang[1]
    def findByLopVang(self, sinhvienvang):
            return self.txtFindVang.text() in sinhvienvang[2]
    def findByNgayVang(self, sinhvienvang):
            return self.txtFindVang.text() in sinhvienvang[3]
    def findByIDBuoiHocVang(self, sinhvienvang):
            return self.txtFindVang.text() in sinhvienvang[4]
    def findByTrangThaiVang(self, sinhvienvang):
            return self.txtFindVang.text() in sinhvienvang[5]
    def showVang(self):
            list2 = []
            if (self.cmbOptionFindVang.currentText() == 'Mã SV'):
                    list2 = filter(self.findByMaSvVang, self.listVang)
            elif (self.cmbOptionFindVang.currentText() == 'Họ tên'):
                    list2 = filter(self.findByHoTenVang, self.listVang)
            elif (self.cmbOptionFindVang.currentText() == 'Lớp'):
                    list2 = filter(self.findByLopVang, self.listVang)
            elif (self.cmbOptionFindVang.currentText() == 'Ngày'):
                    list2 = filter(self.findByNgayVang, self.listVang)
            elif (self.cmbOptionFindVang.currentText() == 'ID buổi học'):
                    list2 = filter(self.findByIDBuoiHocVang, self.listVang)
            elif (self.cmbOptionFindVang.currentText() == 'Trạng thái'):
                    list2 = filter(self.findByTrangThaiVang, self.listVang)
            count = 0
            for index, sv in enumerate(list2):
                    count += 1
                    masv = QtWidgets.QTableWidgetItem()
                    masv.setText(sv[0])
                    self.tbwVang.setItem(index, 0, masv)
                    ten = QtWidgets.QTableWidgetItem()
                    ten.setText(sv[1])
                    self.tbwVang.setItem(index, 1, ten)
                    lop = QtWidgets.QTableWidgetItem()
                    lop.setText(sv[2])
                    self.tbwVang.setItem(index, 2, lop)
                    ngay = QtWidgets.QTableWidgetItem()
                    ngay.setText(sv[3].strftime('%d/%m/%Y'))
                    self.tbwVang.setItem(index, 3, ngay)
                    mabuoiHoc = QtWidgets.QTableWidgetItem()
                    mabuoiHoc.setText(sv[4])
                    self.tbwVang.setItem(index, 4, mabuoiHoc)
                    trangthai = QtWidgets.QTableWidgetItem()
                    trangthai.setText(sv[5])
                    self.tbwVang.setItem(index, 5, trangthai)
            self.tbwVang.setRowCount(count)

    def findByMaSvKDD(self, sinhvienkhongdd):
            return self.txtFindKhongDD.text() in sinhvienkhongdd[0]
    def findByHoTenKDD(self, sinhvienkhongdd):
            return self.txtFindKhongDD.text() in sinhvienkhongdd[1]
    def findByLopKDD(self, sinhvienkhongdd):
            return self.txtFindKhongDD.text() in sinhvienkhongdd[2]
    def findByNgayKDD(self, sinhvienkhongdd):
            return self.txtFindKhongDD.text() in sinhvienkhongdd[3]
    def findByIDBuoiHocKDD(self, sinhvienkhongdd):
            return self.txtFindKhongDD.text() in sinhvienkhongdd[4]
    def findByTrangThaiKDD(self, sinhvienkhongdd):
            return self.txtFindKhongDD.text() in sinhvienkhongdd[5]
    def showKDD(self):
            list3 = []
            if (self.cmbOptionFindKhongDD.currentText() == 'Mã SV'):
                    list3 = filter(self.findByMaSvKDD, self.listKDD)
            elif (self.cmbOptionFindKhongDD.currentText() == 'Họ tên'):
                    list3 = filter(self.findByHoTenKDD, self.listKDD)
            elif (self.cmbOptionFindKhongDD.currentText() == 'Lớp'):
                    list3 = filter(self.findByLopKDD, self.listKDD)
            elif (self.cmbOptionFindKhongDD.currentText() == 'Ngày'):
                    list3 = filter(self.findByNgayKDD, self.listKDD)
            elif (self.cmbOptionFindKhongDD.currentText() == 'ID buổi học'):
                    list3 = filter(self.findByIDBuoiHocKDD, self.listKDD)
            elif (self.cmbOptionFindKhongDD.currentText() == 'Trạng thái'):
                    list3 = filter(self.findByTrangThaiKDD, self.listKDD)
            count = 0
            for index, sv in enumerate(list3):
                    count += 1
                    masv = QtWidgets.QTableWidgetItem()
                    masv.setText(sv[0])
                    self.tbwKhongDD.setItem(index, 0, masv)
                    ten = QtWidgets.QTableWidgetItem()
                    ten.setText(sv[1])
                    self.tbwKhongDD.setItem(index, 1, ten)
                    lop = QtWidgets.QTableWidgetItem()
                    lop.setText(sv[2])
                    self.tbwKhongDD.setItem(index, 2, lop)
                    ngay = QtWidgets.QTableWidgetItem()
                    ngay.setText(sv[3].strftime('%d/%m/%Y'))
                    self.tbwKhongDD.setItem(index, 3, ngay)
                    mabuoiHoc = QtWidgets.QTableWidgetItem()
                    mabuoiHoc.setText(sv[4])
                    self.tbwKhongDD.setItem(index, 4, mabuoiHoc)
                    trangthai = QtWidgets.QTableWidgetItem()
                    trangthai.setText(sv[5])
                    self.tbwKhongDD.setItem(index, 5, trangthai)
            self.tbwKhongDD.setRowCount(count)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", str(now.hour) + ":" + str(now.minute) + ":" + str(now.second)))
        self.label_4.setText(_translate("MainWindow", str(today.day) + "/" + str(today.month) + "/" + str(today.year)))
    ...
    def filedimuon(self):
        x = {'Mã SV':[], 'Họ Tên': [], 'Lớp': [], 'Ngày': [], 'ID buổi học': [], 'Trạng thái': []}
