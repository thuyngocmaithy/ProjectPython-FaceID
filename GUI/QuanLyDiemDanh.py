...
"}")
                ...
                self.cmbOptionFind.addItem("Mã sinh viên", "masv")
...
"}")
        ...
        def update(self):
                ...
                dd = DiemDanh(madiemdanh, masv, giovao, giora, ngay, mabuoihoc, trangthai)
        ...
        def importExcel(self):
                ...
                for r in range(1, sheet.max_row+1):
                        ...
                        # print(madiemdanh,masv,giovao,giora,ngay,mabuoihoc,trangthai)
