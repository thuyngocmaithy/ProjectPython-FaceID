...
class Ui_MainWindow(object):
        ...
        "}")
                ...
                self.btnDangNhap.clicked.connect(self.login_func)
        ...
        def login_func(self):
                ...
                gv = GiangVienBUS()
                if(gv.checkLogin(username,password)):
                        print("Login thành công")
                        self.ui = main.mainGUI()
                        self.ui.mainUi(MainWindow,"home")
                        MainWindow.show()
                        main.mainGUI().mainUi(MainWindow,"home")  
                else:
