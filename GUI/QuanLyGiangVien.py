...
class UI_QuanLyGiangVien(object):
        ...
        "}")
                ...
                self.label_14.setGeometry(QtCore.QRect(20, 230, 81, 21))
                font = QtGui.QFont()
                font.setPointSize(9)
                ...
                self.txtMatKhau.setGeometry(QtCore.QRect(100, 230, 111, 21))                
                font = QtGui.QFont()
                font.setPointSize(9)
        ...
        def loadDataQTable(self):    
                ...
                if list is not None:
                        for row in list:
                                ...
                                self.tbwGiangVien.setItem(tablerow, 4, QtWidgets.QTableWidgetItem(row[4]))
        ...
        def getDataRow(self):
                ...
                self.txtEmail.setText(self.tbwGiangVien.item(cr,3).text())
                self.txtMatKhau.setText(self.tbwGiangVien.item(cr,4).text())
        ...
        def add(self):
                ...
                gv = GiangVien(magiangvien, hoten, sodienthoai,email,matkhau)
                if(gvBUS.add(gv)):
