...
class UI_Home(object):
        ...
        "}")
                icon6 = QtGui.QIcon()
                icon6.addPixmap(QtGui.QPixmap("ui\\../image/password_key_40px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "}")
                icon7 = QtGui.QIcon()
                icon7.addPixmap(QtGui.QPixmap("ui\\../image/logout_40px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
                ...
                icon8 = QtGui.QIcon()
                icon8.addPixmap(QtGui.QPixmap("ui\\../image/close_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
                ...
                icon9 = QtGui.QIcon()
                icon9.addPixmap(QtGui.QPixmap("ui\\../image/subtract_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "}")
                icon10 = QtGui.QIcon()
                icon10.addPixmap(QtGui.QPixmap("ui\\../image/student_center_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "}")
                icon11 = QtGui.QIcon()
                icon11.addPixmap(QtGui.QPixmap("ui\\../image/google_classroom_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "}")
                icon12 = QtGui.QIcon()
                icon12.addPixmap(QtGui.QPixmap("ui\\../image/camera_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "")
                icon13 = QtGui.QIcon()
                icon13.addPixmap(QtGui.QPixmap("ui\\../image/Attendance_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        "")
                icon14 = QtGui.QIcon()
                icon14.addPixmap(QtGui.QPixmap("ui\\../image/teacher_50px.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        def retranslateUi(self, MainWindow):
                ...
                # xác định số sinh viên đang quản lý
                connDb = ConnectDatabase()
                conn = connDb.Connect()
                cursor = conn.cursor()
                query = "SELECT COUNT(masinhvien) FROM `sinhvien` "
                cursor.execute(query)
                row = cursor.fetchone()

                # xác định số buổi học đang diễn ra
                now = datetime.now()
                ...
                conn = connDb.Connect()
                cursor = conn.cursor()
                query2 = "SELECT COUNT(mabuoihoc) FROM `buoihoc` WHERE ngay <= '"+ ngay + "' AND gioketthuc >= '" + gio +"'"
                ...
                self.lblSV.setText(_translate("MainWindow", str(row[0])))
                ...
                self.lblBuoiHoc.setText(_translate("MainWindow", str(row2[0])))

                # Trạng thái
                tt = ['Đóng', 'Mở']
                self.btnCloseCam.setText(_translate("MainWindow", tt[1]))
                self.pushButton_8.setText(_translate("MainWindow", "Trạng thái nhận diện"))
                self.lblStatusCam.setText(_translate("MainWindow", tt[0]))
                self.btnCloseCam.clicked.connect(self.on_btnCloseCam_clicked)
        ...
        def on_btnCloseCam_clicked(self):
        # Xác định trạng thái hiện tại của lblStatusCam và thay đổi nội dung của nó
                current_text = self.lblStatusCam.text()
                if current_text == "Mở":
                        self.lblStatusCam.setText("Đóng")
                        self.btnCloseCam.setText("Mở")
                else:
                        self.lblStatusCam.setText("Mở")
                        self.btnCloseCam.setText("Đóng")
                        self.InputMSV()
        def InputMSV(self):
